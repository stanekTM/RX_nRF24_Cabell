...
//*****************
  ...
  // Forward motor 1
  if (rc_channel[0] > MID_CONTROL_VAL + DEAD_ZONE)
  {
    motor1_val = map(rc_channel[0], MID_CONTROL_VAL + DEAD_ZONE, MAX_CONTROL_VAL, REACTION_MOTOR1, MAX_FORWARD_MOTOR1);
  ...
  // Reverse motor 1
  else if (rc_channel[0] < MID_CONTROL_VAL - DEAD_ZONE)
  {
    motor1_val = map(rc_channel[0], MID_CONTROL_VAL - DEAD_ZONE, MIN_CONTROL_VAL, REACTION_MOTOR1, MAX_REVERSE_MOTOR1);
...
//*****************
  ...
  // Forward motor 2
  if (rc_channel[1] > MID_CONTROL_VAL + DEAD_ZONE)
  {
    motor2_val = map(rc_channel[1], MID_CONTROL_VAL + DEAD_ZONE, MAX_CONTROL_VAL, REACTION_MOTOR2, MAX_FORWARD_MOTOR2);
  ...
  // Reverse motor 2
  else if (rc_channel[1] < MID_CONTROL_VAL - DEAD_ZONE)
  {
    motor2_val = map(rc_channel[1], MID_CONTROL_VAL - DEAD_ZONE, MIN_CONTROL_VAL, REACTION_MOTOR2, MAX_REVERSE_MOTOR2);
...
//***********************************
  ...
  int ch1 = rc_channel[0] / 2, ch2 = rc_channel[1] / 2;
